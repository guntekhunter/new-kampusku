        ...
        <div class="header">
            ...
            <div class="container-cardnya">
                <div class="cardnya">
                    <?php $id = $_GET['id']; ?>
                    <?php if ($id == 2) : ?>
                        <?php $sql1 = mysqli_query($connect, "SELECT * FROM tbl_jurusan ORDER BY tbl_jurusan.id ASC ");
                        ?> <?php while ($result = mysqli_fetch_array($sql1)) : ?> <a href="../halaman/isi_materi.php?id=<?= $result['id']; ?>" class="card-materi">
                                <div class="card-text">
                                    <h4><?= $result['nama_jurusan']; ?></h4>
                                </div>
                            </a>
                        <?php endwhile; ?>
